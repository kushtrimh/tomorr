...
@Table(
    ...
    schema = "public",
    uniqueConstraints = {
        @UniqueConstraint(name = "qrtz_job_details_pkey", columnNames = { "sched_name", "job_name", "job_group" })
    },
    indexes = {
        @Index(name = "idx_qrtz_j_grp", columnList = "sched_name ASC, job_group ASC"),
        @Index(name = "idx_qrtz_j_req_recovery", columnList = "sched_name ASC, requests_recovery ASC")
    }
)
