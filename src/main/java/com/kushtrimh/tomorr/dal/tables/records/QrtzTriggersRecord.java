...
@Table(
    ...
    schema = "public",
    uniqueConstraints = {
        @UniqueConstraint(name = "qrtz_triggers_pkey", columnNames = { "sched_name", "trigger_name", "trigger_group" })
    },
    indexes = {
        @Index(name = "idx_qrtz_t_c", columnList = "sched_name ASC, calendar_name ASC"),
        @Index(name = "idx_qrtz_t_g", columnList = "sched_name ASC, trigger_group ASC"),
        @Index(name = "idx_qrtz_t_j", columnList = "sched_name ASC, job_name ASC, job_group ASC"),
        @Index(name = "idx_qrtz_t_jg", columnList = "sched_name ASC, job_group ASC"),
        @Index(name = "idx_qrtz_t_n_g_state", columnList = "sched_name ASC, trigger_group ASC, trigger_state ASC"),
        @Index(name = "idx_qrtz_t_n_state", columnList = "sched_name ASC, trigger_name ASC, trigger_group ASC, trigger_state ASC"),
        @Index(name = "idx_qrtz_t_next_fire_time", columnList = "sched_name ASC, next_fire_time ASC"),
        @Index(name = "idx_qrtz_t_nft_misfire", columnList = "sched_name ASC, misfire_instr ASC, next_fire_time ASC"),
        @Index(name = "idx_qrtz_t_nft_st", columnList = "sched_name ASC, trigger_state ASC, next_fire_time ASC"),
        @Index(name = "idx_qrtz_t_nft_st_misfire", columnList = "sched_name ASC, misfire_instr ASC, next_fire_time ASC, trigger_state ASC"),
        @Index(name = "idx_qrtz_t_nft_st_misfire_grp", columnList = "sched_name ASC, misfire_instr ASC, next_fire_time ASC, trigger_group ASC, trigger_state ASC"),
        @Index(name = "idx_qrtz_t_state", columnList = "sched_name ASC, trigger_state ASC")
    }
)
public class QrtzTriggersRecord extends UpdatableRecordImpl<QrtzTriggersRecord> implements Record16<String, String, String, String, String, String, Long, Long, Integer, String, String, Long, Long, String, Short, byte[]> {
     ...
     */
    @Column(name = "next_fire_time", precision = 64)
     ...
     */
    @Column(name = "prev_fire_time", precision = 64)
     ...
     */
    @Column(name = "priority", precision = 32)
     ...
     */
    @Column(name = "start_time", nullable = false, precision = 64)
     ...
     */
    @Column(name = "end_time", precision = 64)
     ...
     */
    @Column(name = "misfire_instr", precision = 16)
