...
@Table(
        ...
        schema = "public",
        uniqueConstraints = {
                @UniqueConstraint(name = "qrtz_simprop_triggers_pkey", columnNames = {"sched_name", "trigger_name", "trigger_group"})
        }
)
public class QrtzSimpropTriggersRecord extends UpdatableRecordImpl<QrtzSimpropTriggersRecord> implements Record14<String, String, String, String, String, String, Integer, Integer, Long, Long, BigDecimal, BigDecimal, Boolean, Boolean> {
     ...
     */
    @Column(name = "int_prop_1", precision = 32)
     ...
     */
    @Column(name = "int_prop_2", precision = 32)
     ...
     */
    @Column(name = "long_prop_1", precision = 64)
     ...
     */
    @Column(name = "long_prop_2", precision = 64)
