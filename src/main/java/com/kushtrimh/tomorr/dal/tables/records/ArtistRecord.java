...
public class ArtistRecord extends UpdatableRecordImpl<ArtistRecord> implements Record7<String, String, String, Integer, String, String, LocalDateTime> {
    ...
    /**
     * Setter for <code>public.artist.status</code>.
     */
    ...
    /**
     * Getter for <code>public.artist.status</code>.
     */
    ...
    @Override
    public ArtistRecord value7(LocalDateTime value) {
        setCreatedAt(value);
        return this;
    }

    @Override
    public ArtistRecord values(String value1, String value2, String value3, Integer value4, String value5, String value6, LocalDateTime value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ArtistRecord(String id, String name, String imageHref, Integer popularity, String syncKey, String status, LocalDateTime createdAt) {
        super(Artist.ARTIST);
